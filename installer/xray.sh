...
[[ -e $(which curl) ]] && grep -q "1.1.1.1" /etc/resolv.conf || { 
    ...
    PERMISSION_URL="https://raw.githubusercontent.com/Maniaacxxxc/permission/refs/heads/main/izin.txt"
...
# Detail Hosting
hosting="https://raw.githubusercontent.com/Maniaacxxxc/derf/refs/heads/main"
clear
...
# Tambahkan tugas ke /etc/crontab
